...
# El servidor MCP escucha en el hilo principal vía Server-Sent Events
# Cualquier cliente MCP puede conectarse a: http://localhost:8001/sse
print("MCP server: http://localhost:8001/sse")
mcp.run(transport="sse", host="0.0.0.0", port=int(os.getenv("PORT", 8001)))